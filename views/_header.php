        ...
        <nav class="navbar navbar-expand navbar-light bg-light shadow border-bottom border-primary ">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="home.php">Sri Lanka Army Hospital</a>
                </div>

                <ul class="navbar-nav navbar-right">
                    <li><a href="home.php" class="btn" role="button"><b>HOME</b></a></li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="home.php"><b>HOME</b></a>
                            <a class="dropdown-item" href="update.php">Edit profile </a>
                            <a class="dropdown-item" href="profile.php">View profile </a>
                            <a class="dropdown-item" href="update.php#changePassword">Change Password</a>
