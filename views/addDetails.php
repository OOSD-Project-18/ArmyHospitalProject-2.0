  ...
  <body>
    ...
    <main  id="main">
        ...
        <div class="container py-4">
          ...
          <form action="../handlers/addDetails.inc.php" method="post" class="card p-3">
            ...
            <textarea id = 'details' name="details" rows="8" cols="80" class="form-control" required></textarea>
